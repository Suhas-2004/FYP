...
def get_evidence_matrix():
    """
    Returns structured empirical evidence matrix linking:
    Vanished Visionary Startup -> Futuristic Idea -> Fatal Crisis -> Matched MNC Crisis -> MNC Turnaround Strategy -> Proven Outcome -> Founder Heuristic
    """
    return [
        {
